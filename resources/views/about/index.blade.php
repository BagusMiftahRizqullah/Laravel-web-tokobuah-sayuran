...
@section('konten')
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="{{ asset('style/images/about-img.jpg') }} " alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
                    <h2 class="noo-sh-title-top">Selamat datang di <span> Toko Buah dan Sayuran !</span></h2>
